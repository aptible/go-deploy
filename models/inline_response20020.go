...
// ContextValidate validate this inline response 200 20 based on the context it is used
func (m *InlineResponse20020) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20020) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

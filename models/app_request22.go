...
// AppRequest22 app request 22
//
// swagger:model app_request_22
...
func (m *AppRequest22) validateDestinationAccount(formats strfmt.Registry) error {
...
func (m *AppRequest22) validateType(formats strfmt.Registry) error {
...
// ContextValidate validates this app request 22 based on context it is used
func (m *AppRequest22) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

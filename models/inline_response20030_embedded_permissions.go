...
// InlineResponse20030EmbeddedPermissions inline response 200 30 embedded permissions
// swagger:model inline_response_200_30__embedded_permissions
...
func (m *InlineResponse20030EmbeddedPermissions) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20030EmbeddedPermissions) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20030EmbeddedPermissions) UnmarshalBinary(b []byte) error {
	var res InlineResponse20030EmbeddedPermissions

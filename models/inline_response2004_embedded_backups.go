...
// InlineResponse2004EmbeddedBackups inline response 200 4 embedded backups
// swagger:model inline_response_200_4__embedded_backups
...
func (m *InlineResponse2004EmbeddedBackups) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse2004EmbeddedBackups) validateEmbedded(formats strfmt.Registry) error {
...
func (m *InlineResponse2004EmbeddedBackups) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse2004EmbeddedBackups) UnmarshalBinary(b []byte) error {
	var res InlineResponse2004EmbeddedBackups

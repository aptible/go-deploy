...
// ContextValidate validate this inline response 200 9 embedded based on the context it is used
func (m *InlineResponse2009Embedded) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse2009Embedded) contextValidateConfigurations(ctx context.Context, formats strfmt.Registry) error {

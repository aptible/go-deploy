...
// ContextValidate validate this inline response 200 3 embedded based on the context it is used
func (m *InlineResponse2003Embedded) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse2003Embedded) contextValidateApps(ctx context.Context, formats strfmt.Registry) error {

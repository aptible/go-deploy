...
// InlineResponse2008EmbeddedContainers inline response 200 8 embedded containers
// swagger:model inline_response_200_8__embedded_containers
...
func (m *InlineResponse2008EmbeddedContainers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse2008EmbeddedContainers) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse2008EmbeddedContainers) UnmarshalBinary(b []byte) error {
	var res InlineResponse2008EmbeddedContainers

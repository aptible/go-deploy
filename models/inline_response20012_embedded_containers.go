...
// InlineResponse20012EmbeddedContainers inline response 200 12 embedded containers
// swagger:model inline_response_200_12__embedded_containers
...
func (m *InlineResponse20012EmbeddedContainers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20012EmbeddedContainers) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20012EmbeddedContainers) UnmarshalBinary(b []byte) error {
	var res InlineResponse20012EmbeddedContainers

...
// ContextValidate validates this app request 15 based on context it is used
func (m *AppRequest15) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

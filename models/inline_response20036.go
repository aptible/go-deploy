...
// ContextValidate validate this inline response 200 36 based on the context it is used
func (m *InlineResponse20036) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20036) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

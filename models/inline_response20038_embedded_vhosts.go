...
// InlineResponse20038EmbeddedVhosts inline response 200 38 embedded vhosts
// swagger:model inline_response_200_38__embedded_vhosts
...
func (m *InlineResponse20038EmbeddedVhosts) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20038EmbeddedVhosts) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20038EmbeddedVhosts) validateAcmeConfiguration(formats strfmt.Registry) error {
...
func (m *InlineResponse20038EmbeddedVhosts) UnmarshalBinary(b []byte) error {
	var res InlineResponse20038EmbeddedVhosts

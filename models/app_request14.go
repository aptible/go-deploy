...
// ContextValidate validates this app request 14 based on context it is used
func (m *AppRequest14) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

...
// ContextValidate validates this app request 12 based on context it is used
func (m *AppRequest12) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

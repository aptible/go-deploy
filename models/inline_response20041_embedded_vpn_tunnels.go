...
// InlineResponse20041EmbeddedVpnTunnels inline response 200 41 embedded vpn tunnels
// swagger:model inline_response_200_41__embedded_vpn_tunnels
...
func (m *InlineResponse20041EmbeddedVpnTunnels) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20041EmbeddedVpnTunnels) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20041EmbeddedVpnTunnels) UnmarshalBinary(b []byte) error {
	var res InlineResponse20041EmbeddedVpnTunnels

...
// InlineResponse20027EmbeddedMetricDrains inline response 200 27 embedded metric drains
// swagger:model inline_response_200_27__embedded_metric_drains
...
func (m *InlineResponse20027EmbeddedMetricDrains) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20027EmbeddedMetricDrains) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20027EmbeddedMetricDrains) validateDrainConfiguration(formats strfmt.Registry) error {
...
func (m *InlineResponse20027EmbeddedMetricDrains) UnmarshalBinary(b []byte) error {
	var res InlineResponse20027EmbeddedMetricDrains

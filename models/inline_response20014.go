...
// ContextValidate validate this inline response 200 14 based on the context it is used
func (m *InlineResponse20014) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20014) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

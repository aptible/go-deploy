...
type InlineResponse20014 struct {
	...
	// embedded
	// Required: true
	Embedded *InlineResponse20014Embedded `json:"_embedded"`
...
func (m *InlineResponse20014) validateEmbedded(formats strfmt.Registry) error {
...
func (m *InlineResponse20014) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *InlineResponse20014) validatePerPage(formats strfmt.Registry) error {
...
func (m *InlineResponse20014) validateTotalCount(formats strfmt.Registry) error {

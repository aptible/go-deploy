...
// ContextValidate validate this inline response 200 38 embedded based on the context it is used
func (m *InlineResponse20038Embedded) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20038Embedded) contextValidateStacks(ctx context.Context, formats strfmt.Registry) error {

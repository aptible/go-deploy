...
// InlineResponse20018EmbeddedEmbeddedDisk inline response 200 18 embedded embedded disk
// swagger:model inline_response_200_18__embedded__embedded_disk
...
func (m *InlineResponse20018EmbeddedEmbeddedDisk) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20018EmbeddedEmbeddedDisk) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20018EmbeddedEmbeddedDisk) UnmarshalBinary(b []byte) error {
	var res InlineResponse20018EmbeddedEmbeddedDisk

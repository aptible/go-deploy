...
// ContextValidate validates this app request 36 based on context it is used
func (m *AppRequest36) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

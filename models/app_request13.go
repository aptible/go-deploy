...
// ContextValidate validates this app request 13 based on context it is used
func (m *AppRequest13) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

...
// InlineResponse20047EmbeddedVhosts inline response 200 47 embedded vhosts
// swagger:model inline_response_200_47__embedded_vhosts
...
func (m *InlineResponse20047EmbeddedVhosts) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20047EmbeddedVhosts) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20047EmbeddedVhosts) validateAcmeConfiguration(formats strfmt.Registry) error {
...
func (m *InlineResponse20047EmbeddedVhosts) UnmarshalBinary(b []byte) error {
	var res InlineResponse20047EmbeddedVhosts

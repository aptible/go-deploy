...
// ContextValidate validate this inline response 201 6 based on the context it is used
func (m *InlineResponse2016) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse2016) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InlineResponse2016) contextValidateDrainConfiguration(ctx context.Context, formats strfmt.Registry) error {

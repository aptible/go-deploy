...
// AppRequest25 app request 25
//
// swagger:model app_request_25
...
func (m *AppRequest25) validateDestinationAccount(formats strfmt.Registry) error {
...
func (m *AppRequest25) validateType(formats strfmt.Registry) error {
...
// ContextValidate validates this app request 25 based on context it is used
func (m *AppRequest25) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

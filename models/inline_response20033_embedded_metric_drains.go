...
// InlineResponse20033EmbeddedMetricDrains inline response 200 33 embedded metric drains
// swagger:model inline_response_200_33__embedded_metric_drains
...
func (m *InlineResponse20033EmbeddedMetricDrains) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20033EmbeddedMetricDrains) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20033EmbeddedMetricDrains) validateDrainConfiguration(formats strfmt.Registry) error {
...
func (m *InlineResponse20033EmbeddedMetricDrains) UnmarshalBinary(b []byte) error {
	var res InlineResponse20033EmbeddedMetricDrains

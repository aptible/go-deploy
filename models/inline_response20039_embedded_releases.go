...
// InlineResponse20039EmbeddedReleases inline response 200 39 embedded releases
// swagger:model inline_response_200_39__embedded_releases
...
func (m *InlineResponse20039EmbeddedReleases) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20039EmbeddedReleases) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20039EmbeddedReleases) UnmarshalBinary(b []byte) error {
	var res InlineResponse20039EmbeddedReleases

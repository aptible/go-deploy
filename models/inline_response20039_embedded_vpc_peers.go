...
// InlineResponse20039EmbeddedVpcPeers inline response 200 39 embedded vpc peers
// swagger:model inline_response_200_39__embedded_vpc_peers
...
func (m *InlineResponse20039EmbeddedVpcPeers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20039EmbeddedVpcPeers) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20039EmbeddedVpcPeers) UnmarshalBinary(b []byte) error {
	var res InlineResponse20039EmbeddedVpcPeers

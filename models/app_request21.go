...
// ContextValidate validates this app request 21 based on context it is used
func (m *AppRequest21) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

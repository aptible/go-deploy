...
// ContextValidate validate this inline response 200 32 embedded based on the context it is used
func (m *InlineResponse20032Embedded) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20032Embedded) contextValidatePermissions(ctx context.Context, formats strfmt.Registry) error {

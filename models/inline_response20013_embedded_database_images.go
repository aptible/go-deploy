...
// InlineResponse20013EmbeddedDatabaseImages inline response 200 13 embedded database images
// swagger:model inline_response_200_13__embedded_database_images
...
func (m *InlineResponse20013EmbeddedDatabaseImages) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20013EmbeddedDatabaseImages) validateLinks(formats strfmt.Registry) error {
...
func (m *InlineResponse20013EmbeddedDatabaseImages) UnmarshalBinary(b []byte) error {
	var res InlineResponse20013EmbeddedDatabaseImages

...
// AppRequest24 app request 24
//
// swagger:model app_request_24
...
func (m *AppRequest24) validateDestinationAccount(formats strfmt.Registry) error {
...
func (m *AppRequest24) validateType(formats strfmt.Registry) error {
...
// ContextValidate validates this app request 24 based on context it is used
func (m *AppRequest24) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

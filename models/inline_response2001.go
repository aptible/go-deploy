...
// ContextValidate validate this inline response 200 1 based on the context it is used
...
func (m *InlineResponse2001) contextValidateEmbedded(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InlineResponse2001) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

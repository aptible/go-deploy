...
type InlineResponse20039 struct {
	...
	// embedded
	// Required: true
	Embedded *InlineResponse20039Embedded `json:"_embedded"`

	// links
	// Required: true
	Links *InlineResponse20039Links `json:"_links"`
...
func (m *InlineResponse20039) validateEmbedded(formats strfmt.Registry) error {
...
func (m *InlineResponse20039) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *InlineResponse20039) validatePerPage(formats strfmt.Registry) error {
...
func (m *InlineResponse20039) validateTotalCount(formats strfmt.Registry) error {

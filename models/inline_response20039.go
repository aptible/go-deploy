...
func (m *InlineResponse20039) validateVersionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, inlineResponse20039TypeVersionPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validate this inline response 200 39 based on the context it is used
func (m *InlineResponse20039) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20039) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

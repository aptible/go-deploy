...
// InlineResponse20017EmbeddedLinks inline response 200 17 embedded links
// swagger:model inline_response_200_17__embedded__links
...
func (m *InlineResponse20017EmbeddedLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20017EmbeddedLinks) validateEphemeralSession(formats strfmt.Registry) error {
...
func (m *InlineResponse20017EmbeddedLinks) validateLogDrain(formats strfmt.Registry) error {
...
func (m *InlineResponse20017EmbeddedLinks) validateSelf(formats strfmt.Registry) error {
...
func (m *InlineResponse20017EmbeddedLinks) UnmarshalBinary(b []byte) error {
	var res InlineResponse20017EmbeddedLinks

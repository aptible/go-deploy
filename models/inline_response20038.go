...
// ContextValidate validate this inline response 200 38 based on the context it is used
func (m *InlineResponse20038) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20038) contextValidateEmbedded(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InlineResponse20038) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

...
// ContextValidate validate this inline response 200 embedded based on the context it is used
func (m *InlineResponse200Embedded) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse200Embedded) contextValidateAccounts(ctx context.Context, formats strfmt.Registry) error {

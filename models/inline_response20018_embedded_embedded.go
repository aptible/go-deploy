...
// InlineResponse20018EmbeddedEmbedded inline response 200 18 embedded embedded
// swagger:model inline_response_200_18__embedded__embedded
...
func (m *InlineResponse20018EmbeddedEmbedded) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20018EmbeddedEmbedded) validateDatabaseCredentials(formats strfmt.Registry) error {
...
func (m *InlineResponse20018EmbeddedEmbedded) validateDisk(formats strfmt.Registry) error {
...
func (m *InlineResponse20018EmbeddedEmbedded) validateLastOperation(formats strfmt.Registry) error {
...
func (m *InlineResponse20018EmbeddedEmbedded) UnmarshalBinary(b []byte) error {
	var res InlineResponse20018EmbeddedEmbedded

...
// ContextValidate validates this app request 34 based on context it is used
func (m *AppRequest34) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

...
// AppRequest26 app request 26
//
// swagger:model app_request_26
...
func (m *AppRequest26) validateDestinationAccount(formats strfmt.Registry) error {
...
func (m *AppRequest26) validateType(formats strfmt.Registry) error {
...
// ContextValidate validates this app request 26 based on context it is used
func (m *AppRequest26) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

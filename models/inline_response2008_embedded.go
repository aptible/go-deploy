...
// ContextValidate validate this inline response 200 8 embedded based on the context it is used
func (m *InlineResponse2008Embedded) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse2008Embedded) contextValidateCertificates(ctx context.Context, formats strfmt.Registry) error {

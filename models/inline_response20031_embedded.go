...
// ContextValidate validate this inline response 200 31 embedded based on the context it is used
func (m *InlineResponse20031Embedded) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20031Embedded) contextValidateOperations(ctx context.Context, formats strfmt.Registry) error {

...
// ContextValidate validate this inline response 200 16 based on the context it is used
func (m *InlineResponse20016) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20016) contextValidateEmbedded(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InlineResponse20016) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

...
// InlineResponse20022EmbeddedLinks inline response 200 22 embedded links
// swagger:model inline_response_200_22__embedded__links
...
func (m *InlineResponse20022EmbeddedLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20022EmbeddedLinks) validateEphemeralSession(formats strfmt.Registry) error {
...
func (m *InlineResponse20022EmbeddedLinks) validateLogDrain(formats strfmt.Registry) error {
...
func (m *InlineResponse20022EmbeddedLinks) validateSelf(formats strfmt.Registry) error {
...
func (m *InlineResponse20022EmbeddedLinks) UnmarshalBinary(b []byte) error {
	var res InlineResponse20022EmbeddedLinks

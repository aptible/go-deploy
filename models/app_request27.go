...
// ContextValidate validates this app request 27 based on context it is used
func (m *AppRequest27) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

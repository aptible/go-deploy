...
// ContextValidate validates this app request 3 based on context it is used
func (m *AppRequest3) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

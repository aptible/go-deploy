...
// ContextValidate validates this app request 29 based on context it is used
func (m *AppRequest29) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

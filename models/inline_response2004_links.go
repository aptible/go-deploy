...
// InlineResponse2004Links inline response 200 4 links
// swagger:model inline_response_200_4__links
...
func (m *InlineResponse2004Links) validateAccount(formats strfmt.Registry) error {
...
func (m *InlineResponse2004Links) validateDatabase(formats strfmt.Registry) error {
...
func (m *InlineResponse2004Links) validateNext(formats strfmt.Registry) error {
...
func (m *InlineResponse2004Links) validatePrev(formats strfmt.Registry) error {
...
func (m *InlineResponse2004Links) validateSelf(formats strfmt.Registry) error {
...
func (m *InlineResponse2004Links) UnmarshalBinary(b []byte) error {
	var res InlineResponse2004Links

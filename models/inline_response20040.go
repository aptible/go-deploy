...
// ContextValidate validate this inline response 200 40 based on the context it is used
func (m *InlineResponse20040) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InlineResponse20040) contextValidateEmbedded(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InlineResponse20040) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

...
func (m *InlineResponse200) contextValidateEmbedded(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InlineResponse200) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {

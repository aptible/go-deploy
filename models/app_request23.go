...
// AppRequest23 app request 23
//
// swagger:model app_request_23
...
func (m *AppRequest23) validateDestinationAccount(formats strfmt.Registry) error {
...
func (m *AppRequest23) validateType(formats strfmt.Registry) error {
...
// ContextValidate validates this app request 23 based on context it is used
func (m *AppRequest23) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

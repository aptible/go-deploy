...
// ContextValidate validates this app request 31 based on context it is used
func (m *AppRequest31) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

...
/* DeletePermissionsIDParams contains all the parameters to send to the API endpoint
   for the delete permissions ID operation.
...
// WithDefaults hydrates default values in the delete permissions ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeletePermissionsIDParams) WithDefaults() *DeletePermissionsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete permissions ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeletePermissionsIDParams) SetDefaults() {

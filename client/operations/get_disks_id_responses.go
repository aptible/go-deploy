...
/* GetDisksIDOK describes a response with status code 200, with default header values.
...
func (o *GetDisksIDOK) GetPayload() *models.InlineResponse20018 {
	return o.Payload
}
...
/* GetDisksIDDefault describes a response with status code -1, with default header values.

...
/* GetCertificatesCertificateIDVhostsParams contains all the parameters to send to the API endpoint
   for the get certificates certificate ID vhosts operation.
...
// WithDefaults hydrates default values in the get certificates certificate ID vhosts params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCertificatesCertificateIDVhostsParams) WithDefaults() *GetCertificatesCertificateIDVhostsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get certificates certificate ID vhosts params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCertificatesCertificateIDVhostsParams) SetDefaults() {

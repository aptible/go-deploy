...
/* GetIntrusionDetectionReportsIntrusionReportIDDownloadCsvParams contains all the parameters to send to the API endpoint
   for the get intrusion detection reports intrusion report ID download csv operation.
...
// WithDefaults hydrates default values in the get intrusion detection reports intrusion report ID download csv params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetIntrusionDetectionReportsIntrusionReportIDDownloadCsvParams) WithDefaults() *GetIntrusionDetectionReportsIntrusionReportIDDownloadCsvParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get intrusion detection reports intrusion report ID download csv params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetIntrusionDetectionReportsIntrusionReportIDDownloadCsvParams) SetDefaults() {

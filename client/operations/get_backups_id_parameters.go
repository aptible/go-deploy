...
/* GetBackupsIDParams contains all the parameters to send to the API endpoint
   for the get backups ID operation.
...
// WithDefaults hydrates default values in the get backups ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetBackupsIDParams) WithDefaults() *GetBackupsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get backups ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetBackupsIDParams) SetDefaults() {

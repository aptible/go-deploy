...
/* GetMetricDrainsMetricDrainIDContainersParams contains all the parameters to send to the API endpoint
   for the get metric drains metric drain ID containers operation.
...
// WithDefaults hydrates default values in the get metric drains metric drain ID containers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMetricDrainsMetricDrainIDContainersParams) WithDefaults() *GetMetricDrainsMetricDrainIDContainersParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get metric drains metric drain ID containers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetMetricDrainsMetricDrainIDContainersParams) SetDefaults() {

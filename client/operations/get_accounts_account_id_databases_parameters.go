...
/* GetAccountsAccountIDDatabasesParams contains all the parameters to send to the API endpoint
   for the get accounts account ID databases operation.
...
// WithDefaults hydrates default values in the get accounts account ID databases params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetAccountsAccountIDDatabasesParams) WithDefaults() *GetAccountsAccountIDDatabasesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get accounts account ID databases params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetAccountsAccountIDDatabasesParams) SetDefaults() {

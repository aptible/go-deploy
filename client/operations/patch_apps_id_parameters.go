...
/* PatchAppsIDParams contains all the parameters to send to the API endpoint
   for the patch apps ID operation.
...
// WithDefaults hydrates default values in the patch apps ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchAppsIDParams) WithDefaults() *PatchAppsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the patch apps ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PatchAppsIDParams) SetDefaults() {

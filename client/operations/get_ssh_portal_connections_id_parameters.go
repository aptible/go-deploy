...
/* GetSSHPortalConnectionsIDParams contains all the parameters to send to the API endpoint
   for the get SSH portal connections ID operation.
...
// WithDefaults hydrates default values in the get SSH portal connections ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSSHPortalConnectionsIDParams) WithDefaults() *GetSSHPortalConnectionsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get SSH portal connections ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetSSHPortalConnectionsIDParams) SetDefaults() {

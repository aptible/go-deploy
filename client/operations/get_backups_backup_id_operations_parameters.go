...
// NewGetBackupsBackupIDOperationsParams creates a new GetBackupsBackupIDOperationsParams object,
...
func NewGetBackupsBackupIDOperationsParams() *GetBackupsBackupIDOperationsParams {
	return &GetBackupsBackupIDOperationsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetBackupsBackupIDOperationsParamsWithTimeout creates a new GetBackupsBackupIDOperationsParams object
...
// NewGetBackupsBackupIDOperationsParamsWithContext creates a new GetBackupsBackupIDOperationsParams object
...
// NewGetBackupsBackupIDOperationsParamsWithHTTPClient creates a new GetBackupsBackupIDOperationsParams object
...
/* GetBackupsBackupIDOperationsParams contains all the parameters to send to the API endpoint
   for the get backups backup ID operations operation.
...
// WithDefaults hydrates default values in the get backups backup ID operations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetBackupsBackupIDOperationsParams) WithDefaults() *GetBackupsBackupIDOperationsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get backups backup ID operations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetBackupsBackupIDOperationsParams) SetDefaults() {

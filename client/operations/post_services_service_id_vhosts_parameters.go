...
/* PostServicesServiceIDVhostsParams contains all the parameters to send to the API endpoint
   for the post services service ID vhosts operation.
...
// WithDefaults hydrates default values in the post services service ID vhosts params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostServicesServiceIDVhostsParams) WithDefaults() *PostServicesServiceIDVhostsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post services service ID vhosts params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostServicesServiceIDVhostsParams) SetDefaults() {

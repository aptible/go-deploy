...
/* DeleteAppsIDParams contains all the parameters to send to the API endpoint
   for the delete apps ID operation.
...
// WithDefaults hydrates default values in the delete apps ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteAppsIDParams) WithDefaults() *DeleteAppsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete apps ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteAppsIDParams) SetDefaults() {

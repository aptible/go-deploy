...
/* GetVpcPeersIDParams contains all the parameters to send to the API endpoint
   for the get vpc peers ID operation.
...
// WithDefaults hydrates default values in the get vpc peers ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetVpcPeersIDParams) WithDefaults() *GetVpcPeersIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get vpc peers ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetVpcPeersIDParams) SetDefaults() {

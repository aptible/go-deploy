...
// WithDefaults hydrates default values in the put apps ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutAppsIDParams) WithDefaults() *PutAppsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put apps ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutAppsIDParams) SetDefaults() {

...
/* GetStacksStackIDVpnTunnelsParams contains all the parameters to send to the API endpoint
   for the get stacks stack ID vpn tunnels operation.
...
// WithDefaults hydrates default values in the get stacks stack ID vpn tunnels params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetStacksStackIDVpnTunnelsParams) WithDefaults() *GetStacksStackIDVpnTunnelsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get stacks stack ID vpn tunnels params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetStacksStackIDVpnTunnelsParams) SetDefaults() {

...
/* GetVhostsVhostIDOperationsParams contains all the parameters to send to the API endpoint
   for the get vhosts vhost ID operations operation.
...
// WithDefaults hydrates default values in the get vhosts vhost ID operations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetVhostsVhostIDOperationsParams) WithDefaults() *GetVhostsVhostIDOperationsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get vhosts vhost ID operations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetVhostsVhostIDOperationsParams) SetDefaults() {

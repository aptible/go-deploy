...
/* GetDatabaseCredentialsDatabaseCredentialIDOperationsParams contains all the parameters to send to the API endpoint
   for the get database credentials database credential ID operations operation.
...
// WithDefaults hydrates default values in the get database credentials database credential ID operations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDatabaseCredentialsDatabaseCredentialIDOperationsParams) WithDefaults() *GetDatabaseCredentialsDatabaseCredentialIDOperationsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get database credentials database credential ID operations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDatabaseCredentialsDatabaseCredentialIDOperationsParams) SetDefaults() {

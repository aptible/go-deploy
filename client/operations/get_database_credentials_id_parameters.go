...
// NewGetDatabaseCredentialsIDParams creates a new GetDatabaseCredentialsIDParams object,
...
func NewGetDatabaseCredentialsIDParams() *GetDatabaseCredentialsIDParams {
	return &GetDatabaseCredentialsIDParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDatabaseCredentialsIDParamsWithTimeout creates a new GetDatabaseCredentialsIDParams object
...
// NewGetDatabaseCredentialsIDParamsWithContext creates a new GetDatabaseCredentialsIDParams object
...
// NewGetDatabaseCredentialsIDParamsWithHTTPClient creates a new GetDatabaseCredentialsIDParams object
...
/* GetDatabaseCredentialsIDParams contains all the parameters to send to the API endpoint
   for the get database credentials ID operation.
...
// WithDefaults hydrates default values in the get database credentials ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDatabaseCredentialsIDParams) WithDefaults() *GetDatabaseCredentialsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get database credentials ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDatabaseCredentialsIDParams) SetDefaults() {
